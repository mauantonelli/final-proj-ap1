...
def exibir_menu():
    print("\n=== Menu ===")
    print("1. Listar Mecânicos")
    print("2. Buscar Mecânico")
    print("3. Incluir Mecânico")
    print("4. Alterar Mecânico")
    print("5. Excluir Mecânico")
    print("6. Listar Veículos")
    print("7. Buscar Veículo")
    print("8. Incluir Veículo")
    print("9. Alterar Veículo")
    print("10. Excluir Veículo")
    print("11. Listar Consertos")
    print("12. Buscar Conserto")
    print("0. Sair")
